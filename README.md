...
<p align="center">
	<img src="https://raw.githubusercontent.com/pablo-git8/RetailProductNLP-MatchCluster/main/documentation/images/entity_clustering_output_df.png" alt="200" width="300"/>
</p>
...
<mark style="background-color: yellow;">1.- Pipeline Expansion:</mark> Modify the pipeline to accommodate data from additional retailers (C, D, E, etc.), enhancing flexibility and scalability. This involves adapting the pipeline to read files from various folders and sources.
